...
from evaluate import generate, text_to_token_ids, token_ids_to_text
...
from evaluate import calc_loss_loader, train_model_simple
...
from evaluate import plot_losses
...
def query_model(prompt, model="llama3", url="http://172.26.48.1:11434/api/chat"):
    data = {
        "model": model,
